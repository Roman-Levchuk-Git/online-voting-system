...
//обробка даних, підрахунок результатів та збереження у файли.
public class VotingService {
    ...
    // Пошук голосувань за ключовим словом через Stream API
    ...
    // Логіка голосування: перевіряє чи активне опитування та чи не голосував користувач раніше
    ...
    //паралельний підрахунок з ForkJoin-вища продуктивність
    ...
    public void deleteVoting(String votingId, String username) {
        ...
        if (v != null && v.getHostId().equals(username)) {
            ...
            votes.remove(votingId);
            saveAllData();
        }
    }

    // 2. Статичний метод для завантаження
